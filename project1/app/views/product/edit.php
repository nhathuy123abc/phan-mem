    ...
    <div class="container py-5">
        <div class="form-container">
            <div class="form-header">
                <h1 class="h3 fw-bold">
                    <i class="bi bi-pencil-square text-primary me-2"></i>Chỉnh sửa sản phẩm
                </h1>
            ...
            <form method="POST" action="/project1/Product/edit/<?= $product->getID() ?>" onsubmit="return validateForm()">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="4" required><?= htmlspecialchars($product->getDescription()) ?></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control form-control-lg" id="price" name="price" 
                               value="<?= htmlspecialchars($product->getPrice()) ?>" step="1000" min="0" required>
